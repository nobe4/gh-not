...
func New(actors actors.ActorsMap, notifications notifications.Notifications, renderCache string, keymap config.Keymap) Model {
	model := Model{
		...
		Keys: Keymap{
			up:       keymap.Keybinding("normal", "cursor up"),
			down:     keymap.Keybinding("normal", "cursor down"),
			next:     keymap.Keybinding("normal", "next page"),
			previous: keymap.Keybinding("normal", "previous page"),
			toggle:   keymap.Keybinding("normal", "toggle selected"),
			all:      keymap.Keybinding("normal", "select all"),
			none:     keymap.Keybinding("normal", "select none"),
			open:     keymap.Keybinding("normal", "open in browser"),
			filter:   keymap.Keybinding("normal", "filter mode"),
			command:  keymap.Keybinding("normal", "command mode"),
			help:     keymap.Keybinding("normal", "toggle help"),
			quit:     keymap.Keybinding("normal", "quit"),
		},
		help:        help.New(),
		cursor:      0,
